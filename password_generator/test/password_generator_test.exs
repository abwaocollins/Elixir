defmodule PasswordGeneratorTest do
  ...
  test "returns string with only numbers", %{options_type: options} do
  ...
  test "return string with only symbols", %{options_type: options} do
    options_included = %{
      "length" => "10",
      "numbers" => "false",
      "uppercase" => "false",
  ...
  test "returns a string with all options", %{options_type: options} do
    options_included = %{
      "length" => "10",
      "numbers" => "true",
      "uppercase" => "true",
